...
from electrum_ganja.util import base_units_list
...
from electrum_ganja import coinchooser

from .choice_dialog import ChoiceDialog

Builder.load_string('''
#:import partial functools.partial
#:import _ electrum_ganja_gui.kivy.i18n._

<SettingsDialog@Popup>
    id: settings
    title: _('Electrum-Ganja Settings')
    disable_pin: False
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for MRJA amounts.")
...
class SettingsDialog(Factory.Popup):
    ...
    def __init__(self, app):
        ...
        self.config = self.app.electrum_ganja_config
    ...
    def coinselect_status(self):
        return coinchooser.get_name(self.app.electrum_ganja_config)
