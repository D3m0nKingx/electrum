...
class SimpleConfig(PrintError):
    ...
    def __init__(self, options=None, read_user_config_function=None,
        ...
        self.user_config = {}  # for self.get in electrum_ganja_path()
        self.path = self.electrum_ganja_path()
    ...
    def electrum_ganja_path(self):
        # Read electrum_ganja_path from command line
        # Otherwise use the user's default data directory.
        path = self.get('electrum_ganja_path')
        if path is None:
            path = self.user_dir()
        ...
        self.print_error("electrum-ganja directory", path)
        return path
    ...
    def get_wallet_path(self):
        ...
        old_path = os.path.join(self.path, "electrum-ganja.dat")
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-ganja.conf into user_config[]."""
    if not path:
        return {}
